...
Часто бывает нужно создать проект по какому-то шаблону. В этом шаблоне есть папки, есть файлы с шаблонным текстом, который может быть изменен.

Для того чтобы использовать шаблонный проект - нужно его создать.
